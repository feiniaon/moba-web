<template>
  <div class="page-hero" v-if="model">
    <div class="topbar py-2 text-white bg-black px-3 d-flex ai-center text-white">
    ...
    <div class="top" :style="{'background-image':`url(${model.banner})`}">
      <div class="info text-white p-3 h-100 d-flex flex-column jc-end">
        ...
        <div class="d-flex jc-between">
          <div class="scores pt-2" v-if="model.scores">
            <span>难度</span>
            ...
            <m-card plain icon="cc-menu-circle" title="出装推荐" class="hero-items">
              ...
              <div class="d-flex jc-around text-center mt-3">
                <div v-for="item in model.items1" :key="item.name">
                  ...
                  <div class="fs-xs" style="transform: scale(0.9);">{{item.name}}</div>
                </div>
              </div>
